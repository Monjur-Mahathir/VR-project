...
public class SpawnTiles : MonoBehaviour
{
    ...
    private Vector3 puzzleTilePositionMain;
    ...
    void Update()
    {
        if (Time.time - startTime > timeOffset && GameObject.Find("Push").GetComponent<PhysicsButton>().pressedFirstTime)
        {
           
            direction = mainDirection;

            
            //Code for random direction change of tiles
